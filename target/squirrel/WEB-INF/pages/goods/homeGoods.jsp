    ...
    <nav class="white nav1">
        <div class="nav-wrapper">
            ...
            <div class="nav-wrapper search-bar">
                <form ng-submit="search()" class="ng-pristine ng-invalid ng-invalid-required" action="http://39.102.33.77:8080/squirrel/goods/search">
                ...
                <c:if test="${!empty cur_user}">
                    <li class="publish-btn">
                        <button data-position="bottom" class="red lighten-1 waves-effect waves-light btn">
                            <a href="<%=basePath%>goods/publishGoods">i will publish</a>
                        </button>
                    </li>
                    <li>
                        <a href="<%=basePath%>user/allGoods">goods i published</a>
                    </li>
                    <li>
                    ...
                    <li class="changemore">
                        ...
                        <div class="more-vert">
                            <ul class="dropdown-content">
                                ...
                                <li><a href="<%=basePath%>user/logout">Quit</a></li>
                            </ul>
                        </div>
                    </li>
                </c:if>
